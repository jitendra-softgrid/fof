...
/**
 * @covers  FOF40\Form\Field\CacheHandler::<private>
 * @covers  FOF40\Form\Field\CacheHandler::<protected>
 */
class CacheHandlerLevelTest extends FOFTestCase
{
     ...
     * @covers          FOF40\Form\Field\CacheHandler::__get
     * @dataProvider    CacheHandlerDataprovider::getTest__get
     */
    public function test__get($test, $check)
    {
        $field = $this->getMockBuilder('FOF40\Form\Field\CacheHandler')->setMethods(array('getStatic', 'getRepeatable'))->getMock();
     ...
     * @covers          FOF40\Form\Field\CacheHandler::getStatic
     * @dataProvider    CacheHandlerDataprovider::getTestGetStatic
     */
    public function testGetStatic($test, $check)
    {
        $field = $this->getMockBuilder('FOF40\Form\Field\CacheHandler')->setMethods(array('getInput', 'getFieldContents'))->getMock();
     ...
     * @covers          FOF40\Form\Field\CacheHandler::getRepeatable
     ...
     * @covers          FOF40\Form\Field\CacheHandler::getFieldContents
    ...
    public function testGetFieldContents($test, $check)
    {
        ...
        $field = $this->getMockBuilder('FOF40\Form\Field\CacheHandler')->setMethods(array('getOptions'))->getMock();
