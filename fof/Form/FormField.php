...
abstract class FormField implements FieldInterface
{
	 ...
	 * @var  string
	 */
	protected $renderLayout = 'akeeba.form.renderfield';
	 ...
	 * @var  string
	 */
	protected $renderLabelLayout = 'akeeba.form.renderlabel';
	...
	public function setup(SimpleXMLElement $element, $value, $group = null)
	{
		...
		$attributes = [
			...
			'required', 'disabled', 'readonly', 'autofocus', 'hidden', 'autocomplete', 'spellcheck', 'translateHint',
			'translateLabel',
	...
	protected function getRenderer($layoutId = 'default')
	{
		...
		// Always add FOF's layout path as a fallback
		$defaultLayoutRoot = realpath(__DIR__ . '/../layout');
		$layoutPaths[]     = $defaultLayoutRoot;
