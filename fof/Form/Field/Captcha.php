...
use Joomla\CMS\Captcha\Captcha as CMSCaptcha;
 ...
 */
class Captcha extends FormField implements FieldInterface
{
	/**
	 * The field type.
	 *
	...
	public function getInput()
	{
		...
		{
			if (($captcha = CMSCaptcha::getInstance($this->plugin, ['namespace' => $this->namespace])) == null)
			{
				return '';
			}
		}
